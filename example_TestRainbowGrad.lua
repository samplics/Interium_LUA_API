...
function PaintTraverse()
	...
	Render.RectFilledMultiColor(0, 0, Screen.x, Screen.y, Color.new(R[1], G[1], B[1], 100), Color.new(R[2], G[2], B[2], 100), Color.new(R[3], G[3], B[3], 100), Color.new(R[4], G[4], B[4], 100))
